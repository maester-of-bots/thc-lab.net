...
def fuckingip():
    ...
    if 'hostname' in loc_data.keys():
        ...
        hostname = ''
    return render_template('fuckingip.html', ip=loc_data['ip'],address=loc_data['address'],hostname=hostname,lat=loc_data['lat'],lon=loc_data['lng'],isp=loc_data['org'],isp_url=loc_data['org'].split(" ")[0],zipcode=loc_data['postal'])
